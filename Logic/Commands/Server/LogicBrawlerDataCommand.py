...
class LogicBrawlerDataCommand(Writer):
    ...
    def encode(self):
        ...
        if self.player.UnlockedBrawlers[str(self.brawlerID)] == 0:
            ...
            self.writeVint(blat3) # Reward amount
            self.writeScId(16, int(self.randomBS3)) # CsvID 16
            self.writeVint(6) # Reward ID
            self.writeVint(0) # CsvID 29
            self.writeVint(0) # CsvID 52
            self.writeVint(0) # CsvID 23
            ...
            self.writeVint(blat4) # Reward amount
            self.writeScId(16, int(self.randomBS4)) # CsvID 16
            self.writeVint(6) # Reward ID
            self.writeVint(0) # CsvID 29
            self.writeVint(0) # CsvID 52
            self.writeVint(0) # CsvID 23
            ...
            self.writeVint(blat5) # Reward amount
            self.writeScId(16, int(self.randomBS5)) # CsvID 16
            self.writeVint(6) # Reward ID
            self.writeVint(0) # CsvID 29
            self.writeVint(0) # CsvID 52
            self.writeVint(0) # CsvID 23
            ...
            self.writeVint(blat6) # Reward amount
            self.writeScId(16, int(self.randomBS6)) # CsvID 16
            self.writeVint(6) # Reward ID
            self.writeVint(0) # CsvID 29
            self.writeVint(0) # CsvID 52
            self.writeVint(0) # CsvID 23
